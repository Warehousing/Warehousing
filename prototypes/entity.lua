...
function createLogisticContainer(name, logistic_type, wire_connection)
...
local storehouse_active_provider = createLogisticContainer("storehouse", "active-provider", basic_logistic_storehouse_wcp)
local storehouse_passive_provider = createLogisticContainer("storehouse", "passive-provider", basic_logistic_storehouse_wcp)
local storehouse_storage = createLogisticContainer("storehouse", "storage", basic_logistic_storehouse_wcp)
local storehouse_buffer = createLogisticContainer("storehouse", "buffer", basic_logistic_storehouse_wcp)
local storehouse_requester = createLogisticContainer("storehouse", "requester", basic_logistic_storehouse_wcp)
local warehouse_active_provider = createLogisticContainer("warehouse", "active-provider", basic_logistic_warehouse_wcp)
local warehouse_passive_provider = createLogisticContainer("warehouse", "passive-provider", basic_logistic_warehouse_wcp)
local warehouse_storage = createLogisticContainer("warehouse", "storage", basic_logistic_warehouse_wcp)
local warehouse_buffer = createLogisticContainer("warehouse", "buffer", basic_logistic_warehouse_wcp)
local warehouse_requester = createLogisticContainer("warehouse", "requester", basic_logistic_warehouse_wcp)
