...
local locale_description = "item-description.warehousing-description"
...
data:extend({
	{
		...
		localised_description = ({locale_description, warehouse_slots}),
	...
	},
	{
		...
		localised_description = ({locale_description, storehouse_slots}),
		scale_info_icons = settings.startup["Warehousing-icon-scaling"].value,
		picture =
		{
...
storehouse_active_provider.localised_description = ({locale_description, storehouse_slots})
storehouse_passive_provider.localised_description = ({locale_description, storehouse_slots})
storehouse_storage.localised_description = ({locale_description, storage_storehouse_slots})
storehouse_buffer.localised_description = ({locale_description, storehouse_slots})
storehouse_requester.localised_description = ({locale_description, storehouse_slots})

warehouse_active_provider.localised_description = ({locale_description, warehouse_slots})
warehouse_passive_provider.localised_description = ({locale_description, warehouse_slots})
warehouse_storage.localised_description = ({locale_description, storage_warehouse_slots})
warehouse_buffer.localised_description = ({locale_description, warehouse_slots})
warehouse_requester.localised_description = ({locale_description, warehouse_slots})
